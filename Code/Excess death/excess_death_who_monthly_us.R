...
save(acm_monthly_predictions_tier1, 
     file = "./Output data/Excess death data/acm_monthly_predictions_tier1_us_ed.RData")
...
load(paste0("./Output data/Excess death data/acm_monthly_predictions_tier1_us_ed.RData"))
exp_obs_bymonthyear <- read.csv("./Output data/Death counts data/us_states_mortality.csv")
colnames(exp_obs_bymonthyear) <- c("iso3", "year", "month", "observed")
...
write.csv(df_aux, "./Output data/Excess death data/excess_death_who_monthly_us.csv", 
          row.names = F)
